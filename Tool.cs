...
namespace My_Revit_Commands
{
    ...
    public class Tool : IExternalApplication
    {
        public Result OnStartup(UIControlledApplication application)
        {
            ...
            toolFormButton.LargeImage = new BitmapImage(new Uri(@"C:\Users\Usuario\Dropbox\My PC (DESKTOP-MVTIPMF)\Desktop\Nico\Programación\Revit\My_Revit_Commands\image28.png"));
